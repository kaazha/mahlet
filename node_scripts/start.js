...
var CssModuleDtsCreator = require('./utils/CssModuleDtsCreator');

// Tools like Cloud9 rely on this.
var DEFAULT_PORT = process.env.PORT || 3000;
var compiler;
var handleCompile;
var cssModuleDtsCreator = new CssModuleDtsCreator([
  paths.appSrc + '\\styles\\css\\*.css',
  paths.appSrc + '\\styles\\less\\*.less',
  paths.appSrc + '\\styles\\sass\\*.scss'
], [
  '\\css\\inline',
  '\\less\\inline',
  '\\sass\\inline'
...
function createCssDtsFiles(){
  cssModuleDtsCreator.createAll();
  cssModuleDtsCreator.watch(paths.appSrc + '/styles');
}
...
function runDevServer(port, protocol) {
  var devServer = new WebpackDevServer(compiler, {
    ...
    // DST: Commenting out since webpack 2 doesn't like an empty array
    //contentBase: [],
