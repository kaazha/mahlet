...
module.exports = {
  ...
  performance: {
    hints: false, // enum: false | "error" | "warning"    maxAssetSize: 200000, // int (in bytes),
    maxEntrypointSize: 400000, //4000000 int (in bytes)
    assetFilter: function(assetFilename) {
      // Function predicate that provides asset filenames
      return assetFilename.endsWith('.css') || assetFilename.endsWith('.js');
    }
  },
  devtool: false, /*"source-map"*/ // enum  // enhance debugging by adding meta info for the browser devtools
  ...
  //externals: ["react", "react-dom", /redux/i , 'immer',  /^@material-ui/i],
  serve: { //object
    port: 1337,
    content: './dist',
    // ...
